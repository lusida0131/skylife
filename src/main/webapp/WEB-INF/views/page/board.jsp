...
<div class="container">
	<div class="table-responsive">
		...
		<div class="col-md-9">
			<table class="table table-list-search">
				...
				<c:forEach var="BoardVO" items="${list}">
					<tr>
						<td>${BoardVO.b_num}</td>
						<td><a
							href="${pageContext.request.contextPath}/page/boardView?b_num=${BoardVO.b_num}">${BoardVO.b_title}</a></td>
						<td>${BoardVO.id}</td>
						<td><fmt:formatDate value="${BoardVO.time}"
			...
			<form id='actionForm' action="/page/board" method='get'>
