...
<%@ include file="../layout/header.jsp"%>
	...
	<button class="btn btn-lg btn-primary" style="margin:10px; padding:10px;" type="button" class="btn btn-sm btn-primary" onClick="location.href='/map/map2'">&nbsp;키워드 검색하러 가기&nbsp;</button>
